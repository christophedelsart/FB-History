/*1314142661,169900662,JIT Construction: v428034,fr_FR*/
    ...
    setupAndValidate: function () {
        ...
        function f(i) {
            if (i != 'manual' && i != 'onvisible') {
                var h = i.match(/^\d+(?:\.\d+)?%$/) ? parseInt(i, 10) : 80;
