/*1335915698,169927530,JIT Construction: v550394,fr_FR*/
    ...
    (function () {
                ...
                if (i) {
                    if (e) {
                        ...
                        i.onerror = function (j) {
                            var k;
                            try {
                                k = FB.JSON.parse(j.responseText);
                            } catch (l) {}
                            if (!k || !k.error) k = {
        ...
        FB.subclass('XFBML.LoginButton', 'XFBML.ButtonElement', null, {
            ...
            _getLoginText: function () {
                return this._attr.length == 'short' ? FB.Intl.tx._("Connexion") : FB.Intl.tx._("Log In with Facebook");
            },
            onClick: function () {
                if (!this._attr.registration_url) {
                    if (!FB.getAccessToken() || !this._attr.autologoutlink) {
        ...
        FB.subclass('XFBML.SocialContext', 'XFBML.IframeWidget', null, {
            setupAndValidate: function () {
                ...
                this.subscribe('xd.social_context_stats', FB.bind(this._bubbleSocialContextStats, this));
                return true;
            },
            _bubbleSocialContextStats: function (a) {
                var b = {
                    pluginID: this.getAttribute('plugin-id'),
                    socialContextPageIDs: JSON.parse(a.social_context_page_ids)
                };
