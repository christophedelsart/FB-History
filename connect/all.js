...
FB.provide('Dialog', {
    ...
    _showLoader: function (a) {
        if (!FB.Dialog._loaderEl) FB.Dialog._loaderEl = FB.Dialog._findRoot(FB.Dialog.create({
            content: ('<div class="fb_dialog_loader">' + FB.Intl._tx("Chargement...") + '<a id="fb_dialog_loader_close"></a>' + '</div>')
        }));
    ...
    create: function (e) {
        e = e || {};
        if (e.loader) FB.Dialog._showLoader(e.onClose);
